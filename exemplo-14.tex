% uso de lstlisting para incluir listagem de código fonte
...
\lstinputlisting[frame=single, numbers=left, caption={Exemplo de código fonte}, label=lista1]{exemplo.py}
